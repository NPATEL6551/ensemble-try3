...
public class testvalues {
    ...
    public testvalues(String email, int sex, int age, int current_smoker, int BP_meds, int pre_stroke, int pre_hype, int diabetes,int cigs_per_day, int tot_chol, int sys_BP, int dia_BP, int BMI, int heartrate, int glucose) {
        this.email = email;
        this.sex = sex;
        this.age = age;
